...
func (rdb *Rdb) skipObject(encType byte) (skipStrings int, err error) {
	...
	case RDB_ENCODING_STRING_ENCODING,
		RDB_ENCODING_ZIPMAP_ENCODING,
		RDB_ENCODING_ZIPLIST_ENCODING,
		RDB_ENCODING_HASHMAP_ZIPLIST_ENCODING,
		RDB_ENCODING_INTSET_ENCODING:
		skipStrings = 1
	case RDB_ENCODING_LIST_ENCODING,
		RDB_ENCODING_SET_ENCODING,
